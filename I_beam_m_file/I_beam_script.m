...
dist  = [1000, 2000, 3000, 4000, 100]; % Distance from force applied  

t = 10; % Thickness of I-beam
h = 1:1:1000-2*t; % Height of I-beam 
w = 1:1:1000-2*t; % width of I-beam 

tol = 1.02; % tolerance for the system (how close we want our desired shear modulus to be to the limit)

%% Calling the ibeamfunct function
% Input desired distance in the function: i.e. dist(1), dist(2), etc
[zShear, zInt, XSA, y, Ix, geom] = ibeamfunct(sigma, F, t, h, w, dist(5), tol);
